  ...
  return (
    <div id="about">
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
          ...
          <div className="sub-content">
            <p>
              {" "}
              Where Every cocktail we serve is a reflection of our obsession
              with detail — from the first muddle to the final garnish. That
      ...
      <div className="bottom-grid">
        <div className="md:col-span-8">
          <div className="noisy" />
          <img src="/images/abt2.jpg" alt="grid-img-3" />
        </div>
